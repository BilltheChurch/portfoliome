...
using use = useUsing("use")`,
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "Building AI/ML systems and backend services 🐍🤖",
    color: "#3776AB",
  ...
  [SkillNames.PYTORCH]: {
    ...
    name: "pytorch",
    label: "PyTorch",
    shortDescription: "Deep learning framework that makes AI magic happen ✨🧠",
    color: "#EE4C2C",
  ...
  [SkillNames.NLP]: {
    ...
    name: "nlp",
    label: "NLP",
    shortDescription: "Teaching machines to understand human language 🗣️💬",
    color: "#00ADD8",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg",
  },
  ...
  [SkillNames.AWS]: {
    ...
    label: "AWS",
    shortDescription:
      "Cloud infrastructure that scales with your ambition ☁️🚀",
    color: "#ff9900",
  ...
  [SkillNames.FIGMA]: {
    ...
    name: "figma",
    label: "Figma",
    shortDescription: "Designing beautiful interfaces, one frame at a time 🎨✨",
    color: "#F24E1E",
